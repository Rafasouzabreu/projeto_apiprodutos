...
public class ProdutoServiceImpl implements ProdutoService {
	...
	public void create(ProdutoPostDto dto) throws Exception {
		...
		//verificando se o fornecer não foi encontrado
		if(fornecedor.isEmpty())
			throw new IllegalArgumentException("Erro. A fornecedor informado não existe.");
		//verificando se a categorianão foi encontrada
